...
class ApiSpec extends AnyWordSpec with Matchers {
  ...
  "API endpoints" should {
    "have correct permission scopes" in {
      val routes = api.Api(cli.Commands.ServerOptions(), zio.Console.ConsoleLive, CliLogger(Some(zio.Console.ConsoleLive)), profileRepo = null /*TODO*/, profileStorage = null /*TODO*/).tokenRoutes0
